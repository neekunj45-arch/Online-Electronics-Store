        ...
        <div className="add-img-upload flex-col">
          ...
          <input
            onChange={(e) => {
              ...
              setImagePreview(URL.createObjectURL(e.target.files[0])); // FIX preview
            }}
            type="file"
            id="image"
            hidden
...
//       setData({ name: "", price: "", category: "Mobile", description: "" });
//       setImage(null);
//       setIsEdit(false);
//       setEditProduct(null);
//     } else {
...
//           <div className="add-price flex-col">
//             <p>Product price</p>
//             <input type="number" onChange={onChangeHandler} value={data.price} name='price' placeholder='price' min="1"/>
//           </div>
//         </div>
//         <button type='submit' className='add-btn'>
//           {isEdit ? "Update Product" : "Add Product"}
